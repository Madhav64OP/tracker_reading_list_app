...
function Home() {
  return (
    <>
    <NavBar/>
      <div id="main-body" className='flex-col flex py-8 px-6 gap-4'>
        <div id="heading-welcome" className='text-7xl text-white font-bold text-left animate-glowRed mt-3 mb-5' >Welcome to the App</div>
        <div id="view-your-profile" className=''>
          ...
          <NavLink to="/profile" className='rounded-xl text-black  transition-all duration-300 animate-glowRed bg-red-500 font-semibold py-2 text-xl px-2 justify-end hover:opacity-65'>My Profile</NavLink>
        </div>
