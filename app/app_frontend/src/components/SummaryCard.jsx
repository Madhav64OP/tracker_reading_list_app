...
function SummaryCard({ data }) {
  return (
    <>
      <div id="main-card" className='bg-gray-800 text-white rounded-2xl px-4 py-4 w-250px h-350px max-w-[300px] max-h-[400px] overflow-hidden gap-3 flex justify-center items-center flex-col'>
